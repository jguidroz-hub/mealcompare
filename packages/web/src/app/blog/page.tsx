...
const posts = [
  ...
  {
    slug: 'cheapest-food-delivery-minneapolis',
    title: 'Cheapest Food Delivery in Minneapolis (2026): North Loop to Dinkytown',
    description: 'Minneapolis delivery apps charge 20-30% more — plus a $0.75 city surcharge. We compared real prices.',
    date: 'March 7, 2026',
    tag: 'Minneapolis',
    readTime: '7 min read',
  },
  {
    slug: 'cheapest-food-delivery-detroit',
    title: 'Cheapest Food Delivery in Detroit (2026): Coney Dogs Without the Markup',
    description: 'Detroit delivery apps charge 20-30% more than ordering direct. Jet\'s, Buddy\'s, and more have direct ordering.',
    date: 'March 7, 2026',
    tag: 'Detroit',
    readTime: '7 min read',
  },
  {
    slug: 'cheapest-food-delivery-tampa',
    title: 'Cheapest Food Delivery in Tampa (2026): Cuban Sandwiches Without the Surcharge',
    description: 'Tampa Bay delivery apps charge 20-30% more. We compared prices across Hillsborough and Pinellas counties.',
    date: 'March 7, 2026',
    tag: 'Tampa',
    readTime: '7 min read',
  },
  {
    slug: 'cheapest-food-delivery-san-diego',
    title: 'Cheapest Food Delivery in San Diego (2026): Fish Tacos Without the Fee Stack',
    description: 'San Diego delivery apps charge 20-30% more than ordering direct. California prices + DoorDash markup = ouch.',
    date: 'March 7, 2026',
    tag: 'San Diego',
    readTime: '7 min read',
  },
  {
    slug: 'cheapest-food-delivery-new-orleans',
    title: 'Cheapest Food Delivery in New Orleans (2026): Po-Boys Without the Price Gouge',
    description: 'NOLA delivery apps charge 20-30% more, and 9.45% tax makes it worse. We compared real prices.',
    date: 'March 7, 2026',
    tag: 'New Orleans',
    readTime: '7 min read',
  },
  ...
  {
    slug: 'how-to-save-on-uber-eats',
    title: '9 Ways to Save Money on Uber Eats in 2026',
    description: 'Cut your Uber Eats bill by 25-40%. Is Uber One worth it? Plus the direct ordering trick that saves the most.',
    date: 'March 7, 2026',
    tag: 'Tips',
    readTime: '8 min read',
  },
  {
    slug: 'dashpass-vs-uber-one-vs-grubhub-plus',
    title: 'DashPass vs Uber One vs Grubhub+: Which Is Worth It?',
    description: 'We did the math on all three delivery subscriptions. The answer might be: none of them.',
    date: 'March 7, 2026',
    tag: 'Comparison',
    readTime: '10 min read',
  },
...
const TAG_COLORS: Record<string, { bg: string; text: string }> = {
  ...
  Minneapolis: { bg: '#ede9fe', text: '#5b21b6' },
  Detroit: { bg: '#dbeafe', text: '#1e40af' },
