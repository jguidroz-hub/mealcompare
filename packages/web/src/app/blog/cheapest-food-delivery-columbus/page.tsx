...
export const metadata: Metadata = {
  title: 'Cheapest Food Delivery in Columbus (2026): Buckeye Budget Guide — Eddy Blog',
  description: 'Columbus delivery apps charge 20-30% more than ordering direct. We compared DoorDash, Uber Eats, and direct ordering for popular Columbus restaurants.',
  keywords: ['cheapest food delivery Columbus', 'Columbus food delivery', 'cheap delivery Columbus OH', 'DoorDash Columbus', 'food delivery Columbus Ohio', 'OSU food delivery'],
  alternates: { canonical: 'https://eddy.delivery/blog/cheapest-food-delivery-columbus' },
  openGraph: { title: 'Cheapest Food Delivery in Columbus (2026)', description: 'Real price comparisons for Columbus restaurants.', type: 'article' },
};
    ...
    <main style={{ background: '#fff', color: '#111', minHeight: '100vh', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
      <article style={{ maxWidth: 680, margin: '0 auto', padding: '60px 24px' }}>
        ...
        <div style={{ marginTop: 24, marginBottom: 8 }}>
          <span style={{ background: '#fef2f2', color: '#991b1b', padding: '4px 12px', borderRadius: 999, fontSize: 13, fontWeight: 600 }}>Columbus</span>
        </div>
        <h1 style={{ fontSize: 36, fontWeight: 800, lineHeight: 1.2, marginBottom: 16, letterSpacing: '-0.02em' }}>Cheapest Food Delivery in Columbus (2026): Buckeye Budget Guide</h1>
        ...
        <div style={{ fontSize: 17, lineHeight: 1.8, color: '#374151' }}>
          <p>Columbus is one of the fastest-growing cities in the Midwest, and with 60,000+ Ohio State students, the delivery market is massive. But delivery app fees add up fast — especially on a student budget.</p>
          <p>We compared real prices for popular Columbus restaurants. <strong>Ordering direct saves $5-7 per order on average.</strong></p>

          <h2 style={{ fontSize: 24, fontWeight: 700, marginTop: 40, marginBottom: 16 }}>Price Comparisons: Columbus Favorites</h2>
          ...
          <div style={{ background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: 12, padding: 24, marginBottom: 24 }}>
            ...
            <p style={{ fontSize: 15, color: '#059669', fontWeight: 600, marginTop: 12, marginBottom: 0 }}>You save $4.54 (21%) — Chipotle was founded in Columbus!</p>
          </div>
          ...
          <h2 style={{ fontSize: 24, fontWeight: 700, marginTop: 40, marginBottom: 16 }}>Columbus Restaurants With Direct Ordering</h2>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginBottom: 24 }}>
            {["Chipotle", "Raising Cane's", "Wingstop", "Chick-fil-A", "Panera Bread", "Domino's", "Five Guys", "Donatos Pizza", "Skyline Chili", "White Castle", "MOD Pizza", "Blaze Pizza", "Papa John's", "Buffalo Wild Wings", "Shake Shack", "Bob Evans"].map((name) => (
              <div key={name} style={{ padding: '8px 12px', background: '#f9fafb', borderRadius: 8, fontSize: 15 }}>✅ {name}</div>
            ))}
          </div>

          <h2 style={{ fontSize: 24, fontWeight: 700, marginTop: 40, marginBottom: 16 }}>Columbus-Specific Tips</h2>
          <ul style={{ paddingLeft: 24, marginBottom: 24 }}>
            <li style={{ marginBottom: 8 }}><strong>7.5% Franklin County sales tax</strong> — on inflated app prices</li>
            <li style={{ marginBottom: 8 }}><strong>Chipotle, Wendy&apos;s, and White Castle are all Ohio-born</strong> — all have direct ordering</li>
            <li style={{ marginBottom: 8 }}><strong>OSU students on High Street:</strong> direct ordering 3x/week saves $500-700/semester</li>
            <li style={{ marginBottom: 8 }}><strong>Short North and German Village restaurants often use Toast</strong> — check before using DoorDash</li>
          </ul>
          ...
          <div style={{ background: '#eff6ff', border: '1px solid #bfdbfe', borderRadius: 12, padding: 24, marginBottom: 24 }}>
            <ul style={{ paddingLeft: 20, margin: 0, fontSize: 16 }}>
              ...
              <li><strong>Buckeye game day group orders:</strong> $15-25 saved</li>
            </ul>
          </div>

          <div style={{ background: '#eff6ff', border: '1px solid #bfdbfe', borderRadius: 12, padding: 24, marginTop: 40, textAlign: 'center' as const }}>
            <p style={{ fontWeight: 700, fontSize: 18, marginBottom: 8 }}>Save on every Columbus delivery</p>
