...
const BLACKLIST = new Set([
  // HTML/tech
  'HTTPS', 'HTML', 'JSON', 'NULL', 'TRUE', 'FALSE', 'NONE', 'HREF', 'DATA', 'TYPE',
  // Generic promo words
  'FREE', 'SAVE', 'CODE', 'DEAL', 'BEST', 'SHOP', 'SALE', 'CODES',
  ...
  'REDDIT', 'PROMO', 'COUPON', 'DISCOUNT', 'OFFER', 'SIMPLYCODES',
  // Common English words that regex catches
  'DURING', 'PROVIDES', 'THROUGH', 'STRUCTURE', 'OFFERS', 'OPPORTUNITIES',
  'HIGHER', 'PERCENTAGES', 'VALUES', 'AGGRESSIVE', 'BETTER', 'STATISTICS',
  'AVAILABLE', 'POLICIES', 'QUESTIONS', 'WORKING', 'DETAILS', 'EXCLUSIVE',
  'COUPONS', 'RELEASES', 'BLACK', 'PHRASES', 'THAT', 'VERIFIED',
  'LAST', 'VERIFICATIONS', 'TOTAL', 'FACTS', 'RESTRICTIONS', 'REQUIRES',
  'COMMUNITY', 'THIS', 'ACTIVITY', 'USERS', 'CASES', 'CONTRIBUTORS',
  'MIGHT', 'DOES', 'AFTER', 'MULTIPLE', 'FROM', 'CONTACT',
  'SOMEONE', 'TAKE', 'PREVIOUSLY', 'EXPIRED', 'SIGNUP', 'WHEN',
  'HIGHLIGHTS', 'FAQS', 'REWARDS', 'PROMOTIONS', 'DESCRIPTION', 'VISIT',
  'WHICH', 'SIMPLY', 'HACKS', 'SPECIAL', 'REFUNDS', 'SEARCH',
  'EMAIL', 'ENJOY', 'TODAY', 'YOUR', 'ACCESSIBILITY', 'CASHBACK',
  'RIGHT', 'WILL', 'FREEBIES', 'BEING', 'USAGE', 'APPLY', 'APPLIES',
  'DOESN', 'DISALLOWS', 'WITH', 'AMOUNT', 'REFLECTED', 'SHOULD',
  'LINE', 'POTENTIAL', 'PERCENTAGE', 'PATTERNS', 'FIRST', 'FIELD',
  'CANNOT', 'GIVES', 'EACH', 'SMALLER', 'RESTAURANT', 'PAPER',
  'SCORE', 'REDEEM', 'BUFFALO', 'SHOPPERS', 'HEAD', 'DISCOUNTS',
  'DEPENDING', 'PAGE', 'SITE', 'LINK', 'EDIT', 'POST', 'LIKE', 'HELP',
  'INFO', 'NEWS', 'BLOG', 'TIPS', 'TERMS', 'ABOUT', 'NEWSLETTER',
]);
