...
export default function FeaturePage() {
  const items = [
    { t: "Stripe", d: "2.9% + $0.30 • Annual cost on $100K: $3,200", s: "current" },
    { t: "Square", d: "2.6% + $0.10 • Annual cost on $100K: $2,700 • Save $500/yr", s: "savings" },
    { t: "PayPal", d: "3.49% + $0.49 • Annual cost on $100K: $3,980", s: "expensive" },
    { t: "Helcim", d: "Interchange + 0.4% + $0.08 • Annual cost on $100K: $2,100 • Save $1,100/yr", s: "best" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b px-6 py-3 flex items-center gap-4">
        ...
        <h1 className="font-bold">Fee Comparison</h1>
      </header>
      <div className="max-w-4xl mx-auto px-6 py-8">
        <p className="text-gray-500 text-sm mb-6">Compare processing fees across providers</p>
